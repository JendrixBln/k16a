# Tutorial: https://www.pythontutorial.net/pyqt/pyqt-qdockwidget/

# Das folgende Programm aus dem Tutorial enthält ein vollständiges Beispiel eines Anwendungsfensters
# Ihr könnt dieses Beispiel als Muster verwenden, WENN IHR VERSTEHT, WAS PASSIERT

# Aufgabe 1: Lest Euch das Tutorial durch. Versteht, was das DockWidget macht
# Aufgabe 2: Kommentiert den Code, sodass er von Euch später genutzt werden kann.

import sys
import re
from pathlib import Path
from PyQt6.QtWidgets import QApplication, QMainWindow, QTextEdit, QFileDialog, QMessageBox, QToolBar, QLabel, QDockWidget, QWidget, QFormLayout, QLineEdit, QPushButton
