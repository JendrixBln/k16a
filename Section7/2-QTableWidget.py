# Tutorial:  https://www.pythontutorial.net/pyqt/pyqt-qtablewidget/

# Aufgabe 1: Analysiert das Programm und kommentiert den Code. Ziel ist es, bei Bedarf auf die benötigten Informationen zuzugreifen, um eine solche 
#            tabellarische Ansicht zu erzeugen. 
# Aufgabe 2: Erweitert das Programm so, dass beim Auswählen einer Zeile im TableWidget die Daten in das Bearbeitungsformular rechts übertragen werden
