# https://www.pythontutorial.net/pyqt/pyqt-qlistwidget/

# Gemeinsam anschauen: 
# Zunächst die Funktionalität betrachten und überlegen, was benötigt wird bei insert (Unterschied zu append)
...
class MainWindow(QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('./wishlist.png'))
